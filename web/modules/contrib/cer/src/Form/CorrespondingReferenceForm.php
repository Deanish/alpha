...
class CorrespondingReferenceForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['add_direction'] = [
      '#type' => 'select',
      '#title' => $this->t('Add Direction'),
      '#description' => $this->t('Determines whether newly synced references are added to the top or back of the existing references.'),
      '#options' => [
        'prepend' => $this->t('Prepend'),
        'append' => $this->t('Append'),
      ],
      '#default_value' => $correspondingReference->getAddDirection() ?? 'append',
    ];
    $form['bundles'] = [
      '#type' => 'select',
  ...
  protected function copyFormValuesToEntity(EntityInterface $entity, array $form, FormStateInterface $form_state) {
    ...
    $entity->set('add_direction', $values['add_direction']);
