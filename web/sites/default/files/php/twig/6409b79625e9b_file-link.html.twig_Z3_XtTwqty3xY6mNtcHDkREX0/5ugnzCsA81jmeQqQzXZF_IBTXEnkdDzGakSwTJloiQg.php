...
class __TwigTemplate_aaaf45209b43da58feb0476d7e83eb49 extends Template
{
    private $source;
    private $macros = [];
...
<span";
        ...
        echo ">";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["icon"] ?? null), 16, $this->source), "html", null, true);
        echo " ";
...
";
    ...
    {
        return new Source("", "themes/contrib/bootstrap5/templates/field/file-link.html.twig", "/var/www/html/alpha/web/themes/contrib/bootstrap5/templates/field/file-link.html.twig");
    }
