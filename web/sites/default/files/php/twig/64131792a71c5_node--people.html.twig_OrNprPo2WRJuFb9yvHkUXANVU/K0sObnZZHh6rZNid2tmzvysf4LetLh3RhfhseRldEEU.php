...
\t\t<div class=\"people-email\"><i class=\"fa-solid fa-envelope\"></i>";
        // line 11
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["node"] ?? null), "field_people_email", [], "any", false, false, true, 11), "value", [], "any", false, false, true, 11), 11, $this->source), ["@" => " @ ", "." => " . "]), "html", null, true);
        echo "</div>
...
";
    ...
    {
        return new Source("", "themes/custom/icts/templates/form/node--people.html.twig", "/var/www/html/alpha/web/themes/custom/icts/templates/form/node--people.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array();
        static $filters = array("escape" => 2, "image_style" => 4, "replace" => 11, "check_markup" => 17);
        static $functions = array();

        try {
            $this->sandbox->checkSecurity(
                [],
                ['escape', 'image_style', 'replace', 'check_markup'],
                []
            );
